...
if is_prod:
    discord_login = \
        r"https://discord.com/oauth2/authorize?client_id=985641530356273182&response_type=code&redirect_uri=http%3A%2F%2Fsurfbot.ca%2Fserverlist&scope=identify+guilds+guilds.join+guilds.members.read"
